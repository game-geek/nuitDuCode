...
router.post("/feedback_ai_tank_game", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var username, email, liked, feedback, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                liked = req.body.liked || req.body.liked == "true" ? true : false;
                feedback = req.body.feedback || "";
                if (!(typeof username == typeof String() && username.length > 0 &&
                    ...
                    feedback.length < 20000)) return [3 /*break*/, 2];
                return [4 /*yield*/, (0, db_1.updateFeedbackAiTankGame)(email, username, liked, feedback)];
            case 1:
                data = _a.sent();
                if (data) {
                    res.status(200);
